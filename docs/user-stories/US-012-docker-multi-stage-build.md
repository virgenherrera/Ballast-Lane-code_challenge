...
- [ ] **AC-1: Build stage compiles with the full SDK**
...
- [ ] **AC-2: Test stage gates the build**
...
- [ ] **AC-3: Runtime stage uses a minimal image**
...
- [ ] **AC-4: Final image excludes source code**
...
- [ ] **AC-5: Frontend builds in its own multi-stage pipeline**
...
- [ ] **AC-6: Runtime image exposes a health endpoint**
