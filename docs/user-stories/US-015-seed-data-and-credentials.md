...
- [x] **AC-015.1: Demo user with known credentials**
...
- [x] **AC-015.2: Demo tasks across statuses**
...
- [x] **AC-015.3: Seed runs automatically on first startup**
...
- [x] **AC-015.5: Credentials are demo-appropriate, not production-strength**
