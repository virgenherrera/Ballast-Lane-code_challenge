...
- [x] [EP02 — User Management](epics/EP02-user-management.md)
  - [x] [US-001 — User Registration](user-stories/US-001-user-registration.md)
  - [x] [US-002 — User Login](user-stories/US-002-user-login.md)
  - [x] [US-003 — Protected Access](user-stories/US-003-protected-access.md)
- [x] [EP01 — Task Management](epics/EP01-task-management.md)
  - [x] [US-004 — Create Task](user-stories/US-004-create-task.md)
  - [x] [US-005 — List Tasks](user-stories/US-005-list-tasks.md)
  - [x] [US-006 — View Task Detail](user-stories/US-006-view-task-detail.md)
  - [x] [US-007 — Update Task](user-stories/US-007-update-task.md)
  - [x] [US-008 — Delete Task](user-stories/US-008-delete-task.md)
  - [x] [US-009 — Filter Tasks by Status](user-stories/US-009-filter-tasks-by-status.md)
- [x] [EP03 — GenAI Process Documentation](epics/EP03-genai-documentation.md)
  - [x] [US-010 — Prompt Documentation](user-stories/US-010-prompt-documentation.md)
  - [x] [US-011 — AI Output Validation Report](user-stories/US-011-ai-output-validation.md)
- [x] [EP04 — Frontend (Angular)](epics/EP04-frontend.md)
  - [x] [US-016 — Login & Registration Screen](user-stories/US-016-login-screen.md)
  - [x] [US-017 — Task List View](user-stories/US-017-task-list-view.md)
  - [x] [US-018 — Task Form (Create/Edit)](user-stories/US-018-task-form.md)
  - [x] [US-019 — Responsive Layout & Navigation](user-stories/US-019-responsive-layout.md)
